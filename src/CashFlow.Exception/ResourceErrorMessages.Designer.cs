...
namespace CashFlow.Exception {
    ...
    public class ResourceErrorMessages {
        ...
        /// </summary>
        public static string EXPENSES_CANNOT_FOR_THE_FUTURE3 {
            get {
                return ResourceManager.GetString("EXPENSES_CANNOT_FOR_THE_FUTURE3", resourceCulture);
            }
        }
        ...
        /// </summary>
        public static string EXPENSES_MUST_BE_GREATER_THAN_ZERO {
            get {
                return ResourceManager.GetString("EXPENSES_MUST_BE_GREATER_THAN_ZERO", resourceCulture);
            }
        }
